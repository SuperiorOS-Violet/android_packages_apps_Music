 ...
 */
class superiorAudioPreview : Activity(), OnPreparedListener, OnErrorListener, OnCompletionListener {
    ...
    override fun onCreate(icicle: Bundle?) {
        ...
        setContentView(R.layout.superior_audio_preview)
        ...
        val mAsyncQueryHandler = object : AsyncQueryHandler(contentResolver) {
            override fun onQueryComplete(token: Int, cookie: Any?, cursor: Cursor?) {
                if (cursor != null && cursor.moveToFirst()) {
                    ...
                    mediaMetadataRetriever.setDataSource(this@superiorAudioPreview, mUri)
                    ...
                    if (mediaArtist != null) {
                        ...
                        mTextLine2.text = getString(R.string.superior_audio_preview_artist_unknown)
                    }
                } else {
    ...
    private fun updatePlayPause() {
        ...
        if (b != null && mPlayer != null) {
            if (mPlayer!!.isPlaying) {
                b.setImageResource(R.drawable.superior_audio_preview_pause_ic)
            } else {
                b.setImageResource(R.drawable.superior_audio_preview_play_ic)
                mProgressRefresher.removeCallbacksAndMessages(null)
            }
        }
    }
    ...
    private class PreviewPlayer : MediaPlayer(), OnPreparedListener {
        private lateinit var mActivity: superiorAudioPreview
        var isPrepared = false

        fun setActivity(activity: superiorAudioPreview) {
            mActivity = activity
